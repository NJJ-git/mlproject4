...
class FaceRecognition:    
    ...
    def trainFace(self):
        ...
        path = BASE_DIR2+'/faceDetect/dataset'
        ...
        recognizer.save(BASE_DIR2+'/faceDetect/trainer/trainer.yml') # recognizer.save() worked on Mac, but not on Pi
    ...
    def recognizeFace(self):
        recognizer.read(BASE_DIR2+'/faceDetect/trainer/trainer.yml')
